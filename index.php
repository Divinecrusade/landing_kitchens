...
<html lang="ru">
	<head>
        ...
        <meta name="description" content="Кухни на заказ от фабрики в Орле. Собственное производство. Изготовление от 14 дней. Онлайн расчет стоимости кухни. Бесплатная доставка в пределах города. Гарантия на кухни 5 лет">
	...
	<body>
        ...
        <script src="<?=ASSETS_PATH?>assets/js/showMore.js"></script>
        <script src="<?=ASSETS_PATH?>assets/js/showMoreRetarget.js"></script>
        <script>
