    ...
    var cookieChoices = (function() {
        ...
        function showCookieBar(data) {
            ...
            if (typeof data != 'undefined' && typeof data.linkHref != 'undefined') {
                ...
                data.styles = data.styles || 'position:fixed; width:100%; background-color:rgba(255, 255, 255, 0.9); margin:0; left:0;' + data.position + ':0; padding:4px; z-index:1000; text-align:center;';


                switch (data.language) {
                    case "ru":
                        data.cookieText = data.cookieText || "Используя наш сайт, вы соглашаетесь на использование файлов cookie. ";
